...
export function Profile(emu_settings, profile) {
...
Profile.prototype.initAsync = async function () {
  await this.rom.init();
...
Profile.prototype.load = async function (data) {
...
Profile.prototype.load_dump = async function (dump) {
